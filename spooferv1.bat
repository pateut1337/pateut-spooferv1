...
@echo off
chcp 65001
title SPOOFER VERSION V1 - BY BRIGADA GIGI
cls
mode 80,15
echo.
echo.
...
timeout 2 >nul
echo.
echo [31m[] Leaked By Brigada Gigi[0m
timeout 3 >nul
echo.
...
echo.
echo.
echo                                                                                BAN EVADE FIVEM SPOOFER - LEAKED BY BRIGADA GIGI  
echo.
echo.
echo                                    [31m1[0m - [32mCLEAN CACHE FIVEM[0m                       [31m2[0m - [32mSPOOFER FIVEM[0m
echo.
echo.
echo                                    [31m100[0m - [32mCLEAN/SPOOF FOR ALL[0m                 [31mFIX[0m - [32mFIX PROBLEMS FOR FIVEM[0m
echo.
echo.
echo.
echo.
...
echo.
echo.
echo                                                     [31m60[0m - [32mFIX LINK DISCORD FOR FIVEM[0m 
echo.
echo.
echo.
echo.
...
echo.
echo.
echo                                                       [ FIXED LINKED DISCORD FOR FIVEM ] !!
timeout 2 >nul
goto FIX
...
echo.
echo.
echo                             [31m7[0m - [32mUNLINK SOCIAL CLUB FOR FIVEM[0m                       [31m8[0m - [32mUNLINK CITIZENFX FOR FIVEM[0m
echo.
echo.
echo                             [31m9[0m - [32mSPOOFER FOR FIVEM[0m                                  [31m10[0m - [32mUNLINK DISCORD FOR FIVEM[0m                        
echo.
echo.
echo.
set /p key=key : 
...
echo.
echo.
echo                                   [31m3[0m - [32mCLEAN CACHE FOR FIVEM[0m                       [31m4[0m - [32mCLEAN CRASHES FOR FIVEM[0m
echo.
echo.
echo                                   [31m5[0m - [32mCLEAN LOGS FOR FIVEM[0m                        [31m6[0m - [32mCLEAN MODS FOR FIVEM[0m
echo.
echo.
echo.
set /p key=key : 
